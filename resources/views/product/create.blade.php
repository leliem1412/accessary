...
@section('content')
    <div class="breakcrumb-container">
        ...
        <div class="btn-breakcrumb-box">
            <button type="submit" class="btn btn-primary btn_create">Lưu</button>
        </div>
   </div>
        ...
        <div class="block-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select select2" aria-label="Default select example" name="product_category" id="product_category">
...
<script>
    const Customer_CreateView_Js = new class {
        ...
        handleFormSubmitEvent() {
            this.$createBtnField.on('click', (e) => {
                event.preventDefault();
                ...
                const productImage = this.$formField.find('input[name=product_image]');
