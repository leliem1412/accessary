        ...
        <div class="block-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    {!! App\Enums\Picklist::getPicklistView('service', 'Vui lòng chọn loại dịch vụ', 'service_category') !!}
                </div>
    ...
    const Customer_CreateView_Js = new class {
        ...
        handleFormSubmitEvent() {
            this.$createBtn.on('click', (event) => {
                ...
                const productImage = $('input[name=service_image]');
